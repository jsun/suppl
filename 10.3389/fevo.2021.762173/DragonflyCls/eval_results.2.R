...
spmodel_valid_stats_image <- summarise_valid_stats('weights_species', 'image', 'Tw_valid')
spmodel_valid_stats_d50   <- summarise_valid_stats('weights_species', 'd50', 'Tw_valid')
...
write_tsv(valid_sum_table[valid_sum_table$topacc == 'Top-1', -3],
          path = 'eval_results2/validacc_top1.tsv', col_names = TRUE)
write_tsv(valid_sum_table[valid_sum_table$topacc == 'Top-3', -3],
          path = 'eval_results2/validacc_top3.tsv', col_names = TRUE)
write.table(spmodel_valid_stats_image$confmat, 
            file = 'eval_results2/validconfmatrix_W2F_resnet152_1_image.tsv', sep = '\t')
write.table(spmodel_valid_stats_d50$confmat, 
            file = 'eval_results2/validconfmatrix_W2F_resnet152_1_mesh.tsv', sep = '\t')


png('eval_results2/validacc_barplot_image.png', 3800, 1800, res = 460)
print(spmodel_valid_stats_image$accfig)
dev.off()

png('eval_results2/validacc_barplot_mesh.png', 3800, 1800, res = 460)
print(spmodel_valid_stats_d50$accfig)
dev.off()


png('eval_results2/trainstats_species_history.png', 2200, 1800, res = 220)
print(spmodel_train_stats$fig$acc_history)
dev.off()
png('eval_results2/trainstats_species_acc.png', 2200, 1800, res = 220)
...
gnmodel_valid_stats_image <- summarise_valid_stats('weights_genus', 'image', 'Twg_valid')
gnmodel_valid_stats_d50   <- summarise_valid_stats('weights_genus', 'd50', 'Twg_valid')
...
write_tsv(valid_sum_table[valid_sum_table$topacc == 'Top-1', -3],
          path = 'eval_results2/validaccg_top1.tsv', col_names = TRUE)
write_tsv(valid_sum_table[valid_sum_table$topacc == 'Top-3', -3],
          path = 'eval_results2/validaccg_top3.tsv', col_names = TRUE)
write.table(gnmodel_valid_stats_image$confmat, 
            file = 'eval_results2/validconfmatrixg_W2F_resnet152_1_image.tsv', sep = '\t')
write.table(gnmodel_valid_stats_d50$confmat, 
            file = 'eval_results2/validconfmatrixg_W2F_resnet152_1_mesh.tsv', sep = '\t')


png('eval_results2/validaccg_barplot_image.png', 3800, 1800, res = 460)
print(gnmodel_valid_stats_image$accfig)
dev.off()

png('eval_results2/trainstats_genus_history.png', 2200, 1800, res = 220)
print(gnmodel_train_stats$fig$acc_history)
dev.off()
png('eval_results2/trainstats_genus_acc.png', 2200, 1800, res = 220)
