...
do
    ...
    time python train.py --class-label ${DATA_PATH}/dragonfly_classes.txt \
                ...
                --model-outpath ./weights_species/W2__${model_arch}__${i}.pth \
                --traindata ${DATA_PATH}/dataset_W2/train_images \
...
do
    ...
    time python train.py --class-label ${DATA_PATH}/dragonflyg_classes.txt \
                --model-arch ${model_arch} \
                --model-outpath ./weights_genus/W2g__${model_arch}__${i}.pth \
                --traindata ${DATA_PATH}/dataset_W2g/train_images \
