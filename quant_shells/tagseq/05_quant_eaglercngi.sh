...
BIN=~/local/aaic/bin
UTILS=~/local/aaic/nutilfunc
EAGLE_SCRIPT_DIR=~/local/aaic/src/eagle/scripts

DATA_DIR=${PROJECT_DIR}/data/tagseq
CLEAN_FASTQ_DIR=${DATA_DIR}/clean_fastq
BAM_DIR=${DATA_DIR}/bameaglercngi
COUNTS_DIR=${DATA_DIR}/countseaglrcngi
EAGLE_DIR=${DATA_DIR}/eaglercngi

GENOME_DIR=/home/sonk414/data/genome/IWGSC_RefSeq_v1.1_CS
